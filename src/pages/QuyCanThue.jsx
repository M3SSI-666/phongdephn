...
const st = {
  ...
  toaHeader:   { background:'rgba(255,255,255,0.07)', padding:'7px 0', textAlign:'center', borderTop:'1px solid rgba(255,255,255,0.1)', borderBottom:'1px solid rgba(255,255,255,0.1)' },
  toaLabel:    { fontWeight:700, fontSize:13, color:'rgba(255,255,255,0.5)', letterSpacing:3, textTransform:'uppercase' },
