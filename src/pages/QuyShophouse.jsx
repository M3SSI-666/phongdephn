...
function QuyShophouseInner() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .sh-row:hover { background: ${C.primaryBg} !important; }
...
const st = {
  ...
  modal: { background: '#fff', borderRadius: 16, width: 560, maxWidth: '100%', maxHeight: '90vh', display: 'flex', flexDirection: 'column', boxShadow: C.shadowLg, animation: 'shSlideUp 0.25s ease', overflow: 'hidden' },
  ...
  confirmBox: { background: '#fff', borderRadius: 16, padding: '24px', width: 380, maxWidth: '100%', boxShadow: C.shadowLg, animation: 'shSlideUp 0.2s ease' },
