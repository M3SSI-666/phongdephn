...
{"Thiet_Ke":null,"Slot_Xe":null,"Gia_Max":null,"Gia_Min":null,"Huong_BC":null,"Noi_That":null,"Toa":null,"Khu":null,"Truc":null,"Tang_Min":null,"Tang_Max":null,"DT_Min":null,"DT_Max":null,"Top_N":null}
...
- Top_N: how many BEST-VALUE units to return, as an INTEGER. Set it only when the query asks for a ranking by price: "top 10 căn ... giá tốt nhất"→10, "top15"→15, "lấy 20 căn rẻ nhất"→20. If the query says "giá tốt"/"giá rẻ"/"rẻ nhất"/"giá ngon"/"giá mềm" with NO number, use 10. null otherwise.
  Careful: the number MUST come from the ranking phrase, never from the bedroom count. "3PN giá tốt" is Thiet_Ke="3PN" and Top_N=10, NOT Top_N=3. Also "nội thất tốt"/"hướng tốt" is about furniture/direction, not price — leave Top_N null there.
