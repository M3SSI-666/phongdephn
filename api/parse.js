...
- ghi_chu: ONLY include info that TENANTS would care about. List POSITIVE things first, then NEGATIVE things. Positives examples: Giờ giấc tự do, Không chung chủ, Cho nuôi pet, Nhận xe điện, Nhận khách nước ngoài, Khóa vân tay, Vệ sinh khép kín, Ban công. Negatives examples: Không nuôi pet, Không nhận khách nước ngoài, Chung chủ, Giờ giấc. DO NOT include: diện tích, hoa hồng, mã toà nhà, commission - these are NOT relevant to tenants. Keep concise, comma-separated.
